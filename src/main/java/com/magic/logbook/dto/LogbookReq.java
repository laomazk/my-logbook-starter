...
/**
 * @author: mazikai
 * @created: 2021-08-26 13:57
 */
@Getter
@Setter
@JsonInclude
//保持content中各key的顺序, 后续会按照该顺序匹配各key的值
@JsonPropertyOrder({"correlation", "type", "uri", "method", "origin", "body", "headers", "originalCallApp"})
public class LogbookReq implements Serializable {
